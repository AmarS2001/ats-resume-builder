...
- **Tense Consistency:** Ensure absolute consistency. Never mix tenses within the same role block.
- **Forbidden weak openers:** Responsible for · Helped · Assisted · Worked on · Involved in · Participated in · Contributed to. Replace with strong, distinct action verbs.
- **Vocabulary Diversity:** Do not repeat the same action verb to open multiple bullets. Keep the vocabulary diverse.
- **No Vague Phrasing:** Avoid vague descriptions (e.g., 'improved performance' or 'optimized query'). Always specify *how* (using specific tech) and *what* was accomplished with concrete metrics.
- **No Typos or Grammar Slips:** Ensure perfect spelling, correct punctuation, and grammatically flawless sentences.
...
```
<em>Title</em>, Journal/Conference Name, Year — <a href="...">[full_url]</a>
```
Bold the key term or finding. The URL link text must match the exact URL string (unaliased).
